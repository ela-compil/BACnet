...
namespace System.IO.BACnet
{
    public abstract class EnumClassUtils<TClass> where TClass : class
    {
        ...
        public static int DecodeEnumerated<TEnum>(byte[] buffer, int offset, uint lenValue, out TEnum value)
        {
        ...
        public static int DecodeContextEnumerated<TEnum>(byte[] buffer, int offset, byte tagNumber, out TEnum value)
        {
            ...
            return len + EnumUtils.DecodeEnumerated(buffer, offset + len, lenValue, out value);
        }
    }
